...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h4>Dispositivo:</h4><h1>{v}</h1>";
const char * const HTTP_PORTAL_MENU[] PROGMEM = {
"<form action='/wifi'    method='get'><button>Configuración WiFi</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Configure WiFi (No Scan)</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>Info</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>Avanzadas</button></form><br/>\n",//MENU_PARAM
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Guardando credenciales<br/>Intentando conectar dispositivo a la red.<br />*Si falla, vuelva a conectarse al AP para intentarlo de nuevo</div>";
const char HTTP_PARAMSAVED[]       PROGMEM = "<div class='msg S'>Guardado<br/></div>";
const char HTTP_END[]              PROGMEM = "</div><br/><br/><br/><br/><br/><h4>Teca Perú S.A.C© espx portal R0.9</h4><p>Soporte técnico: <a href='mailto:administracion@teca.pe'>administracion@teca.pe</a></p></body></html>";
const char HTTP_ERASEBTN[]         PROGMEM = "<br/><form action='/erase' method='get'><button class='D'>Restablecimiento de fábrica</button></form>";
const char HTTP_BACKBTN[]          PROGMEM = "<hr><br/><form action='/' method='get'><button>Retroceder</button></form>";

const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>Conectado</strong> to {v}<br/><em><small>with IP {i}</small></em></div>";
const char HTTP_STATUS_OFF[]       PROGMEM = "<div class='msg {c}'><strong>No Conectado</strong> to {v}{r}</div>";
...
const char HTTP_STATUS_OFFFAIL[]   PROGMEM = "<br/>No es posible conectart"; // WL_CONNECT_FAILED
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>AP no seteado</div>";
...
const char HTTP_HELP[]             PROGMEM =
 ...
 "</table>"
 "<p/>More information at <a href='https://teca.pe'>https://teca.pe</a>.";
